...
** Installation
   ...
   ([[https://github.com/cisco/ChezScheme][Chez Scheme (v10.4.1)]] is required)
...
*** Basic steps
    ...
    By following steps,
    you can easily compile and run the test case.
...
*** Global installation
    ...
    1. Compile: ~echo '(compile-file "src/xml.sls")' | scheme -q~
    2. Create lib directory: ~/Library/chezscheme/.
    3. Copy ~xml.so~ to this directory.
    4. Append ~/Library/chezscheme/ to ~CHEZSCHEMELIBDIRS~.
    5. Then, ~(import (xml))~ works in any project.
...
*** Load and import library
    ...
    #+begin_src scheme
      (load "./src/xml.sls") ;; this line can be commented
